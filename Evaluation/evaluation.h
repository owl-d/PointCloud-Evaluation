...
RMSE computeRMSE_point2point(const pCloudPtr& P, const pCloudPtr& G, double max_corr_mm = 1e9);
RMSE computeRMSE_point2plane(const pCloudPtr& P, const pCloudPtr& G, const v3f& nP, const v3f& nG, double max_corr_mm = 1e9);
